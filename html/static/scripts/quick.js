...
var Quick = {
	container: document.getElementById("quick"),
	...
	replace: function(str){
		...
		str = str.replace(/\*([a-z0-9-]+)\*/g, '<img src="static/quick/$1.png" width="28px" height="28px" style="vertical-align:middle;">');

		return str;
	},

	init: function(){
		for(var slug in Quick.db){
			var obj = document.createElement('li');
			obj.innerHTML = '<img src="static/quick/' + slug + '.png" width="28px" height="28px" style="vertical-align:middle;">';
			obj.dataset.slug = slug;
			obj.onclick = function(){
				Quick.textarea.insertAtCaret(' *' + this.dataset.slug + '* ');
				Quick.textarea.focus();
			};

			Quick.container.onmousedown = function(e){
				e.preventDefault();
			};
			Quick.container.appendChild(obj);
		}

		var toggle = Quick.container.style.display;
		Quick.quick_btn.onclick = function(){
			if(toggle == "none"){
				Quick.container.style.display = "inline-block";
				toggle = "block";
			} else {
				Quick.container.style.display = "none";
				toggle = "none";
			}
		};
	}
